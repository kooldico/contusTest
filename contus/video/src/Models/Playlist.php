...
class Playlist extends Model {
    ...
    /**
     * Function to return video count in each video playlist
     * @return number
     */
    ...
    public function getFollowingAttribute() {
        return (auth ()->user ()) ? $this->authFollower ()->count () : 0;
    }

    /**
     * Function to return first video details in the playlist
     * @return number
     */
    public function getVideoInfoAttribute() {
        return $this->videos()->selectRaw('videos.id, videos.slug, videos.thumbnail_image')->first();
    }
}
