...
class AudioTranslation extends Model implements AttachableModel
{
    /**
     ...
     * @var string
     */
    protected $table = 'audio_translation';
    /**
     * Morph class name
     *
     * @var string
     ...
     * @var array
     */
    protected $fillable = [ 'audio_id','language_id','audio_title','audio_description' ];
